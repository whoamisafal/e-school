...
class PDFNoticeView extends StatefulWidget {
   final NoticeModel model;
   final int index;
   PDFNoticeView({this.model,this.index});
  @override
  _PDFNoticeViewState createState() => _PDFNoticeViewState();
}

class _PDFNoticeViewState extends State<PDFNoticeView> {
UserModel userModel;
